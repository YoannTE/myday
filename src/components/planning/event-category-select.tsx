...
interface EventCategorySelectProps {
  ...
  onCategoryCreated: (categorie: EventCategory) => void;
  disabled?: boolean;
}

/**
 * Sélecteur de catégorie d'événement avec création inline ("+ Nouvelle
 * catégorie") - miroir de `NoteCategorySelect` (notes, Round 015) appliqué
 * aux événements : la couleur est toujours auto-assignée par le backend
