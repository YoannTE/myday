...
const LONGUEUR = 4;
const TOUCHES = ["1", "2", "3", "4", "5", "6", "7", "8", "9", "", "0", "retour"];
 ...
 */
export function VerrouBudget({ etat, onOuvert }: VerrouBudgetProps) {
  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center">
      <div
        ref={carteRef}
        className="fade-in w-full max-w-sm rounded-card bg-card p-7 text-center shadow-card"
      >
