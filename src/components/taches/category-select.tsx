...
/**
 * Sélecteur de catégorie de tâche avec création inline ("+ Nouvelle
 * catégorie", Round 012, F2) : la couleur est toujours auto-assignée par le
 * backend (palette tournante), l'utilisateur ne saisit que le nom.
 */
